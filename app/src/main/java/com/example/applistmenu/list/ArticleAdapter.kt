...
import com.example.applistmenu.databinding.MenuListItemBinding
...
class ArticleAdapter(val onClick:(dish_item: ArticleModel)->Unit): RecyclerView.Adapter<ArticleAdapter.ArticleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        ...
        Glide.with(holder.binding.dishImage.context).load(currentElement.image).apply(requestOptions).into(holder.binding.dishImage)
